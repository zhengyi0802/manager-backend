        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <select id="type" name="type" >
                     <option value="video" selected >{{ __('mainvideos.type_video') }}</option>
                     <option value="playlist" >{{ __('mainvideos.type_playlist') }}</option>
                     <option value="youtube_url" >{{ __('mainvideos.type_youtube_url') }}</option>
                     <option value="youtube_id" >{{ __('mainvideos.type_youtube_id') }}</option>
